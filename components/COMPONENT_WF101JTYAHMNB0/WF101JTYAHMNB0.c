...
*
* Parameters:
*  mipi_dsi_base: Pointer to the MIPI DSI base address.
*
* Return:
*  cy_en_gfx_status_t: Graphics API result (cy_en_gfx_status_t enumeration type)
*
*******************************************************************************/
cy_en_gfx_status_t wf101jtyahmnb0_init(GFXSS_MIPIDSI_Type* mipi_dsi_base)
{
    ...
    /* Perform reset. */
    /* Toggle the CYBSP_DISP_RST pin to low */
    cyhal_gpio_toggle(CYBSP_DISP_RST);
    cyhal_system_delay_ms(PIN_LOW_DELAY_MS);

    /* Toggle the CYBSP_DISP_RST pin to high */
    cyhal_gpio_toggle(CYBSP_DISP_RST);
